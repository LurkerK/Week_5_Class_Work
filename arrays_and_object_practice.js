...
let hundredEuros = 100
let exchangeRateAUD = rates["AUD"];
let hundredEurosInAUD = (hundredEuros * exchangeRateAUD).toFixed(2)

console.log(`100 Euros is equal to ${hundredEurosInAUD} Australian Dollars(AUD).`)
console.log('')
...
cats_and_owners.forEach( function( cats_and_owners) {
  console.log('one cat and owner', cats_and_owners)
  let owner = cats_and_owners.name
  let cat = cats_and_owners.cat
...
// ChatGPT was used in this section
...
let physicsLaureatesIds = nobel_prize_winners_2017.prizes.find(prize => prize.category === "physics").laureates.map(laureate => laureate.id)
console.log(`The ids of Physics Nobel laureates are: ${physicsLaureatesIds.join(", ")}`)

// TODO write code to print the names of all of the prize categories (So your output would start physics, chemistry, medicine... ).
let prizeCategories = nobel_prize_winners_2017.prizes.map(prize => prize.category)
console.log(`The prize categories are: ${prizeCategories.join(", ")}`)

// TODO write code to print the total number of prize categories
let totalPrizeCategories = prizeCategories.length
console.log(`The total number of prize categories is: ${totalPrizeCategories}`)

// TODO write code to count the total number of laureates from 2017. 
let totalLaureates2017 = nobel_prize_winners_2017.prizes.reduce((total, prize) => total + prize.laureates.length, 0)
console.log(`The total number of laureates from 2017 is: ${totalLaureates2017}`)